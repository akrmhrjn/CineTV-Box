...
public class Upcomming extends Fragment {
	...
	//private static String url = "http://192.168.10.101/cinetvbox_api/gettypemovie_api.php";
	//private static String urlcat = "http://192.168.10.101/cinetvbox_api/getcategorymovie_api.php";
	// JSON Node names
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		pagename.setText("UPCOMING MOVIES");
    ...
    private class GetMovie extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
         ...
         // Building Parameters
 			...
 			params.add(new BasicNameValuePair("type", "Upcoming Movies"));
